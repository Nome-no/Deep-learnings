...
### 1. Implementación de Data Augmentation *
...
### 2. Evaluación del impacto de Data Augmentation)*
...
### 3. Implementación de Transfer Learning *
...
### 4. Entrenamiento y evaluación del modelo con Transfer Learning)*
...
### 5. Documentación y organización del código*
...
1. Abrir `Semana9_Actividad9` en [Google Colab](https://colab.research.google.com/)
2. Activar GPU: *Entorno de ejecución → Cambiar tipo de entorno → T4 GPU*
3. Ejecutar todo con `Ctrl + F9`
4. Tiempo estimado con GPU: **8 minutos**
